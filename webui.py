...
def generate_audio(
    text, temperature, top_P, top_K, audio_seed_input, text_seed_input, refine_text_flag
):
...
def main():
    ...
    parser.add_argument(
        "--local_path", type=str, default=None, help="the local_path if need"
    )
    ...
    demo.launch(
        server_name=args.server_name, server_port=args.server_port, inbrowser=True
    )
